...
= 
 ...
 \end{pmatrix}
	...
	Par conséquent, la matrice dynamique $A_{lin}$ du système linéarisé est telle que : $A_{lin} = J_f$. En considérant maintenant le vecteur d'entrée U tel que $U =  [W_f \quad C_{charge}]^t$, alors la matrice d'entrée $B_lin$ du système linéarisé est telle que : 
